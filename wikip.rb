...
TEAMS = { "Giant Clam" => ["taylor%20swift", "count%20dracula", "comet", "giant%20clam", "mitch%20mcconnell", "republican%20party%20(united%20states)", "democratic%20party%20(united%20states)", "murphy's%20law", "eiffel%20tower", "general%20motors"],
          ...
          "E-Cigs in space" => ["benedict%20cumberbatch", "stephen%20colbert", "hydraulic%20fracturing", "asteroid", "hillary%20rodham%20clinton", "israel", "quantitative%20easing", "electronic%20cigarette", "international%20space%20station", "beck"],
          "The Google, The Veto, and the Mr. Mom" => ["michael%20keaton", "green%20day", "petroleum", "google", "veto", "iraq", "japan", "clint%20eastwood", "apple%20inc.", "eminem"],
          "Wiki Wiki What?!" => ["chicago%20blackhawks", "nascar", "snow", "tesla%20motors", "fox%20news%20channel", "africa", "deaths%20in%202015", "walmart", "catherine,%20duchess%20of%20cambridge", "central%20intelligence%20agency"],
