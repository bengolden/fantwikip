...
PAGE_VIEWS = {
          ...
          '201404' => {"taylor swift" => [302800,30],"count dracula" => [28617,30],"comet" => [43341,30],"giant clam" => [9092,30],"mitch mcconnell" => [22554,30],"republican party (united states)" => [117251,30],"democratic party (united states)" => [108069,30],"murphy's law" => [79500,30],"eiffel tower" => [193879,30],"general motors" => [107590,30],"reese witherspoon" => [105885,30],"katy perry" => [406630,30],"stephen hawking" => [303262,30],"eclipse" => [39372,30],"iran" => [194659,30],"fidel castro" => [168016,30],"moon" => [176889,30],"angela merkel" => [77666,30],"jesus" => [303510,30],"mila kunis" => [395353,30],"fifty shades of grey" => [194662,30],"julianne moore" => [120061,30],"oculus rift" => [122521,30],"exxonmobil" => [43558,30],"kim jong-un" => [211070,30],"wichita" => [2959,30],"guantanamo bay naval base" => [23633,30],"antonin scalia" => [42755,30],"bob dylan" => [209936,30],"lithuania" => [134449,30],"jurassic park" => [29182,30],"bank" => [58659,30],"opec" => [58824,30],"ruth bader ginsburg" => [35580,30],"npr" => [24681,30],"silicon valley" => [149539,30],"barack obama" => [546384,30],"netflix" => [200523,30],"assassination_of_john_f._kennedy" => [118452,30],"american football" => [90376,30],"benedict cumberbatch" => [274837,30],"stephen colbert" => [391341,30],"hydraulic fracturing" => [116565,30],"asteroid" => [44899,30],"hillary rodham clinton" => [151849,30],"israel" => [288531,30],"quantitative easing" => [60615,30],"beck" => [83610,30],"international space station" => [142403,30],"electronic cigarette" => [186096,30],"michael keaton" => [74479,30],"green day" => [132928,30],"petroleum" => [94190,30],"google" => [738086,30],"veto" => [19202,30],"iraq" => [106172,30],"clint eastwood" => [338509,30],"apple inc." => [304878,30],"eminem" => [547832,30],"japan" => [385766,30],"chicago blackhawks" => [59439,30],"nascar" => [45606,30],"snow" => [24578,30],"tesla motors" => [143614,30],"deaths in 2015" => [6,3],"walmart" => [121339,30],"catherine, duchess of cambridge" => [214163,30],"central intelligence agency" => [90850,30],"africa" => [180756,30],"fox news channel" => [44576,30],"spongebob squarepants" => [126702,30],"liam neeson" => [243918,30],"el niño" => [111276,30],"koch industries" => [193566,30],"john boehner" => [36394,30],"ebola" => [68150,30],"pope francis" => [203131,30],"bashar al-assad" => [104573,30],"facebook" => [1399555,30],"patient protection and affordable care act" => [134554,30]},
...
MONTH_ADJUSTMENT = 30.0 / (Time.now.day - 1)

SCORING_METHOD = "averages"

def standard_run
  if !PAGE_VIEWS["201504"]
...
def get_updated_projections
  TEAMS.values.each do |array|
    array.each do |article|
      views_for_article(article,"2015","04", true)
    end
  end
  print "}\n"
end
...
def views_for_article(article, year, month, display = false)
  cached_value = PAGE_VIEWS["#{year}#{month}"][article] if PAGE_VIEWS["#{year}#{month}"]
  if cached_value
...
#   TEAMS.each do |k,v|
#     v.each do |art|
#       ratios[art] = (PAGE_VIEWS['201504'][art].to_f / PAGE_VIEWS['201404'][art]).round(2)
#     end
#   end
